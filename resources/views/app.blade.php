    ...
    <section class="relative bg-gradient-to-r from-black via-brand-bg to-brand-bg py-16 border-b border-brand-border">
        <div class="max-w-7xl mx-auto px-4 flex flex-col md:flex-row items-center justify-between gap-8">
            ...
            <div
                ...
                <i
                    class="fa-solid fa-paper-plane text-7xl text-brand-red/30 group-hover:scale-110 transition duration-500"></i>
    ...
    <main id="katalog" class="max-w-7xl mx-auto px-4 py-12 flex-1">
        ...
        <div class="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-4 md:gap-6">
            ...
            <div
                ...
                <div>
                    <div class="h-44 bg-neutral-800 relative flex items-center justify-center">
                    ...
                    <div class="p-4">
                        <p class="text-xs text-gray-400 mb-1">Gelasan Aduan</p>
                        <h3 class="font-semibold text-white text-sm line-clamp-2 group-hover:text-brand-red transition">
                            Gelasan HKSD Joker Special Edition 2000 Yard
                        </h3>
                    </div>
                </div>
                <div class="p-4 pt-0">
                    <div class="flex items-center justify-between mt-2">
                        <div>
                            <p class="text-xs text-gray-500 line-through">Rp 85.000</p>
                            <p class="text-base font-bold text-brand-red">Rp 65.000</p>
                        </div>
                        <button
            ...
            <div
                ...
                <div>
                    ...
                    <div class="p-4">
                        <p class="text-xs text-gray-400 mb-1">Layangan</p>
                        <h3 class="font-semibold text-white text-sm line-clamp-2 group-hover:text-brand-red transition">
                            Layangan Sukhoi Super Tournament (Pack 10 Pcs)
                        </h3>
                    </div>
                </div>
                <div class="p-4 pt-0">
                    <div class="flex items-center justify-between mt-2">
                        <div>
                            <p class="text-base font-bold text-white">Rp 35.000</p>
                        </div>
                        <button
                            class="bg-brand-red/10 text-brand-red hover:bg-brand-red hover:text-white p-2.5 rounded-lg transition">
                            <i class="fa-solid fa-cart-plus"></i>
            ...
            <div
                ...
                <div>
                    ...
                    <div class="p-4">
                        ...
                        <h3 class="font-semibold text-white text-sm line-clamp-2 group-hover:text-brand-red transition">
                            Pelindung Jari / Tape Pelindung Gesekan Benang
                        </h3>
                    </div>
                </div>
                <div class="p-4 pt-0">
                    <div class="flex items-center justify-between mt-2">
                        <div>
                            <p class="text-base font-bold text-white">Rp 12.000</p>
                        </div>
                        <button
                            class="bg-brand-red/10 text-brand-red hover:bg-brand-red hover:text-white p-2.5 rounded-lg transition">
                            <i class="fa-solid fa-cart-plus"></i>
            ...
            <div
                ...
                <div>
                    ...
                    <div class="p-4">
                        <p class="text-xs text-gray-400 mb-1">Gulungan</p>
                        <h3 class="font-semibold text-white text-sm line-clamp-2 group-hover:text-brand-red transition">
                            Gulungan Kayu Jati Ukir Premium 8 Inch
                        </h3>
                    </div>
                </div>
                <div class="p-4 pt-0">
                    <div class="flex items-center justify-between mt-2">
                        <div>
                            <p class="text-base font-bold text-white">Rp 120.000</p>
                        </div>
                        <button
                            class="bg-brand-red/10 text-brand-red hover:bg-brand-red hover:text-white p-2.5 rounded-lg transition">
                            <i class="fa-solid fa-cart-plus"></i>
